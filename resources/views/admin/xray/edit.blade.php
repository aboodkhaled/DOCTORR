                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form col-md-12 " action="{{route('admin.x_rays.update' ,$xray -> id)}}"
                                              method="POST"
                                                ...
                                                <div class="row col-12 ">
                                                    <div class="col-6 col-sm-6 py-2 ">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$xray -> getTranslation('name','ar')}}" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="name">
                                                            @error("name")
                                                    ...
                                                    <div class="col-6 col-sm-6 py-2 ">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$xray -> getTranslation('name','en')}}" id="name_en"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="name_en">
                                                            @error("name_en")
                                                    ...
                                                    <div class="col-6 col-sm-6 py-2 ">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" value="{{$xray -> price}}" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="price">
                                                            @error("price")
                                                    ...
                                                    <div class="col-12 col-sm-6 py-2 ">
                                                        <div class="form-group mt-1">
                                                            <input type="checkbox" value="1"
                                                                   ...
                                                                   @if($xray -> active  == 1 ) checked @endif
                                                                   />
