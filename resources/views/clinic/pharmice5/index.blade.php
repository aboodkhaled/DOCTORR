...
@section('content')
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('clinic.serve5s')}}"> خدمات  أخرئ  </a>
                                </li>
                                <li class="breadcrumb-item active">أظافة خدمة   
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> أظافة خدمة    </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form col-md-12 " action="{{route('clinic.serve5s.save')}}"
                                              method="POST"
                                            ...
                                            @csrf
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i> بيانات ألخدمات  ألاخرئ</h4>
    ...
    <div class="app-content content">
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title"> ألخدمات  ألاخرئ  </h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('clinic.dashboard')}}">ألصفحة ألرئيسية</a>
                                </li>
                                <li class="breadcrumb-item active">   ألخدمات  ألاخرئ
                                </li>
                            </ol>
                        </div>
                    </div>
                ...
                <section id="dom">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">جميع ألخدمات  ألاخرئ</h4>
                                    <a class="heading-elements-toggle"><i
                                            class="la la-ellipsis-v font-medium-3"></i></a>
                                    <div class="heading-elements">
                                        <ul class="list-inline mb-0">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <table
                                            ...
                                            @isset($serve5s)
                                                @foreach($serve5s as $serve5)
                                                    <tr>
                                                        <td>{{$serve5 -> name}}</td>
                                                       
                                                        <td> {{$serve5 -> think}}</td>
                                                        <td> {{$serve5 ->price}}</td>
                                                        <td>{{$serve5 -> thin_price}}</td>
                                                        <td>{{$serve5 -> total}}</td>
                                                        <td> {{$serve5 -> getActive()}}</td>
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                 aria-label="Basic example">
                                                                <a href="{{route('clinic.serve5s.edit',$serve5 ->id)}}"
                                                                   class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">{{trans('pharmice_trans.Edite')}}</a>


                                                                <a href="{{route('clinic.serve5s.delete',$serve5 ->id)}}"
