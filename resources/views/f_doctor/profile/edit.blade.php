                ...
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{Route('f_doctor.dashboard')}}">الرئيسية </a>
                                </li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('f_doctor.update.profile')}}"
                                              method="post"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            onchange="console.log('change is firing')"><label for="projectinput2"> {{trans('doctor_trans.Chose Cuontry')}}</label>
                                                                ...
                                                                @foreach($hcuontrys as $hcuontry)
                                                                            <option
                                                                                value="{{$hcuontry -> id }}"
                                                                                @if($hdoctors -> fcuontry_id == $hcuontry -> id) selected @endif
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="fcity_id" id="fcity_id" class="select form-control">
                                                                ...
                                                                @foreach($hcitys as $hcity)
                                                                            <option
                                                                                value="{{$hcity -> id }}"
                                                                                @if($hdoctors -> fcity_id == $hcity -> id) selected @endif
                                                                ...
                                                                <optgroup label="من فضلك أختر القسم ">
                                                                    ...
                                                                    @foreach($hdepartments as $hdepartment)
                                                                            <option
                                                                                ...
                                                                                @if($hdoctors -> fdepartment_id == $hdepartment -> id) selected @endif
                                                            ...
                                                            <select name="fspecialty_id" class="select2 form-control">
                                                                <optgroup label="من فضلك أختر ألتخصص ">
                                                                    @if($hspecialtys && $hspecialtys -> count() > 0)
                                                                        ...
                                                                        <option
                                                                                value="{{$hspecialty -> id }}"
                                                                                @if($hdoctors -> fspecialty_id == $hspecialty -> id) selected @endif
...
<script>
        $(function(){
            ...
            function  populateFcities(){
                ...
                $.get("{{Route('f_doctor.doctors.getcity')}}",{fcuontry_id: hcuontryId }, function(data){
