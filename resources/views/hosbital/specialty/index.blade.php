                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('hosbital.specialtys.save')}}" method="POST"
                                ...
                                <td>{{ $i }}</td>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                <a href="{{route('hosbital.specialtys.edit',$hspecialty -> id)}}"
                                                                   class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">{{trans('spechial_trans.Edite')}}</a>


                                                                <a href="{{route('hosbital.specialtys.delete',$hspecialty -> id)}}"
