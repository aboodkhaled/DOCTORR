...
class serve3_total extends Model
{
   
   
    
    protected $table ="serve3_totals";
    protected $fillable = [
      'serve3_id', 'total', 'clinic_id', 'created_at', 'updated_at',
    ];
    protected $hidden = [
    ...
    public function clinic(){
      ...
      public function appoemint3(){
        return $this -> hasMany(appoemint3::class, 'serve3_total_id', 'id' );
    }
}
