        ...
        <div class="navbar-container content">
         ...
         <h1>لغة ألموقع</h1>
                ...
                <ul class="nav navbar-nav float-right">
                  ...
                  <span
                      class="user-name text-bold-600">  {{auth('doctorr') -> user() -> doc_name}}   </span><span class="avatar avatar-sm avatar-busy rounded-circle"><img class="brand-logo" alt="modern admin logo"
                             src="{{auth('doctorr') -> user() -> photo}}"> </span>
                            <br> {{auth('doctorr') -> user() -> email}}                            
                </span>
                
                
                         </a>
                         
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="{{route('doctor.edit.profile')}}"><i
                                    class=""></i> تعديل الملف الشحصي </a>
                        
                                    
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{route('doctor.logout')}}"><i class="ft-power"></i> تسجيل
                                الخروج </a>
                        </div>
                    </li>
