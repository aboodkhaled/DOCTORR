...
class serve1_thin extends Model
{
   
    protected $table ="serve1_thins";
    protected $fillable = [
      'serve1_id', 'think', 'clinic_id', 'created_at', 'updated_at',
    ];
    protected $hidden = [
    ...
    public function clinic(){
      ...
      public function appoemint1(){
        return $this -> hasMany(appoemint1::class, 'serve1_thin_id', 'id' );
    }
}
