                ...
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{trans('city_trans.Dashbord')}} </a>
                                </li>
                                <li class="breadcrumb-item"><a href="{{route('admin.cities.index')}}"> {{trans('city_trans.Cities')}}</a>
                                </li>
                                <li class="breadcrumb-item active">{{trans('city_trans.Edite City')}} {{$city -> name}}
                                </li>
                            </ol>
                        </div>
                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="cuontry_id" class="select2 form-control">
                                                                <optgroup label="من فضلك أختر ألدولة ">
                                                                    @if($cuontry && $cuontry -> count() > 0)
                                                                        @foreach($cuontry as $_cuontry)
                                                                            <option
                                                                            value="{{$_cuontry -> id }}"
                                                                                @if($city -> cuontry_id == $_cuontry -> id) selected @endif
