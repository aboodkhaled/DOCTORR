...
class serve3_price extends Model
{
   
   
    
    protected $table ="serve3_prices";
    protected $fillable = [
      'serve3_id', 'price', 'clinic_id', 'created_at', 'updated_at',
    ];
    protected $hidden = [
    ...
    public function clinic(){
      ...
      public function appoemint3(){
        return $this -> hasMany(appoemint3::class, 'serve3_price_id', 'id' );
    }
}
