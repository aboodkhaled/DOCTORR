        ...
        <div class="navbar-container content">
         ...
         <h1>لغة ألموقع</h1>
                ...
                <span class="mr-1">{{trans('main_trans.Hello')}}
                  ...
                  <span
                      class="user-name text-bold-600">  {{auth('admin') -> user() -> name}}   </span><span class="avatar avatar-sm avatar-busy rounded-circle"><img class="brand-logo" 
                             src="{{auth('admin') -> user() -> photo}}"> </span>
                            <br> {{auth('admin') -> user() -> email}}                            
                </span>
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        <a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon ft-bell"></i>
                            ...
                            data-count="" ><h6 id="notifications_coun">{{auth('admin')->user()->unreadNotifications->count() }}</h6></span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            ...
                            <li class="dropdown-menu-header">
                                ...
                                <span
                                    class="notification-tag badge badge-default badge-danger float-right m-0"><h6 id="notifications_cou">{{auth('admin')->user()->unreadNotifications->count() }}</h6></span>
                            </li>
                            
                            <li class="scrollable-container media-list w-100">
                            <div id="unreadNotificats">
                            @foreach(auth('admin')->user()->unreadNotifications as $notification)
                                <a href="{{route('admin.appoemints.show',$notification->data['id'])}}">
                                    <div class="media">
                           ...
                           <div>
                            <li class="dropdown-menu-footer"><a class="dropdown-item text-muted text-center"
                                                                href="{{route('admin.appoemints.MarkAsRead')}}"> {{trans('lab_trans.Read all notifications')}}</a>
                            </li>
                            </div>
