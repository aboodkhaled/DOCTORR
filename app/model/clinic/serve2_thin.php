...
class serve2_thin extends Model
{
   
   
    
    protected $table ="serve2_thins";
    protected $fillable = [
      'serve2_id', 'think', 'clinic_id', 'created_at', 'updated_at',
    ];
    protected $hidden = [
    ...
    public function clinic(){
      ...
      public function appoemint2(){
        return $this -> hasMany(appoemint2::class, 'serve2_thin_id', 'id' );
    }
}
