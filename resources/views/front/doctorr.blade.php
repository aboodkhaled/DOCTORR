 ...
 <div class="page-banner overlay-dark bg-image" style="background-image: url({{asset('assets/front/u/assets/img/bg_image_1.jpg')}});">
    <div class="banner-section">
      <div class="container text-center wow fadeInUp">
        ...
        <h1 class="font-weight-normal ">   <br> {{$department -> dept_name}}</h1>
      </div> <!-- .container -->
    </div> <!-- .banner-section -->
  </div> <!-- .page-banner -->
  ...
  <div class="page-section">
    <div class="container">
       <h1 class="text-center mb-5 wow fadeInUp">جميع أطباء   <br> {{$department -> dept_name}} </h1>
      ...
      @isset($doctor)
        ...
        <div class="item">
          ...
          <div class="card-doctor">
            ...
            <a href="{{route('doctor.details',$doctors -> id)}}"><span class="mai-person"></span>
              <img height="280px"  src="{{$doctors -> photo}}" alt=""></a>
              
              <div class="meta">
                <a href="{{route('doctor.details',$doctors -> id)}}"><span class="mai-person"></span></a>
            ...
            <div class="body">
              ...
              <span class="text-sm text-grey"></span><br>
                  <span class="text-sm text-grey"> {{$doctors -> specialty -> special_name}} :  ألتخصص  </span><br>
                  <span class="text-sm text-grey">{{$department -> dept_name}}  :  ألقسم</span>
            </div>
          </div>
        </div>
