                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form col-md-12 " action="{{route('fhosbital.doctorserves.update' ,$hdoctor_serve -> id)}}"
                                              method="POST"
                                                                ...
                                                                <optgroup label="من فضلك أختر ألخدمة ">
                                                                    @if($hserves && $hserves -> count() > 0)
                                                                        @foreach($hserves as $hserve)
                                                                            <option
                                                                                value="{{$hserve -> id }}"
                                                                                @if($hdoctor_serve -> fserve_id == $hserve -> id) selected @endif>{{$hserve -> serv_name}}</option>
                                                                        @endforeach
                                                                    @endif
                                                                </optgroup>
                                                            </select>
                                                                ...
                                                                <optgroup label="من فضلك أختر ألطبيب ">
                                                                    @if($hdoctors && $hdoctors -> count() > 0)
                                                                        @foreach($hdoctors as $hdoctor)
                                                                            <option
                                                                            value="{{$hdoctor -> id }}"
                                                                                @if($hdoctor_serve -> fdoctor_id == $hdoctor -> id) selected @endif
