...
class serve5_thin extends Model
{
   
   
    
    protected $table ="serve5_thins";
    protected $fillable = [
      'serve5_id', 'think', 'clinic_id', 'created_at', 'updated_at',
    ];
    protected $hidden = [
    ...
    public function clinic(){
      ...
      public function appoemint5(){
        return $this -> hasMany(appoemint5::class, 'serve5_thin_id', 'id' );
    }
}
