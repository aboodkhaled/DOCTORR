...
class serve4_tprice extends Model
{
    
   
    
    protected $table ="serve4_tprices";
    protected $fillable = [
      'serve4_id', 'thin_price', 'clinic_id', 'created_at', 'updated_at',
    ];
    protected $hidden = [
    ...
    public function clinic(){
      ...
      public function appoemint4(){
        return $this -> hasMany(appoemint4::class, 'serve4_tprice_id', 'id' );
    }
}
