...
class serve4_thin extends Model
{
   
   
    
    protected $table ="serve4_thins";
    protected $fillable = [
      'serve4_id', 'think', 'clinic_id', 'created_at', 'updated_at',
    ];
    protected $hidden = [
    ...
    public function clinic(){
      ...
      public function appoemint4(){
        return $this -> hasMany(appoemint4::class, 'serve4_thin_id', 'id' );
    }
}
