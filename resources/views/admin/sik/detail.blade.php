						...
						<div class="card" id="basic-alert">
							<div class="card-body">
                                ...
                                <td>{{ $i }}</td>
													<td>{{$y -> id}}</td> 
													<td>{{$y ->user-> name}}</td>
													<td>{{$y ->doctor-> doc_name}}</td>
													<td>{{$y ->specialty-> special_name}}</td>
													<td>{{$y ->department-> dept_name}}</td>
													<td>{{$y ->serve-> serv_name}}</td>
													<td>{{$y ->doctor_serve-> price}}</td>
