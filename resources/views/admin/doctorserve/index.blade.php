                                        ...
                                        <table
                                            ...
                                            @isset($doctor_serves)
                                                @foreach($doctor_serves as $doctor_serve)
                                                    <tr>
                                                        <td>{{$doctor_serve -> serve -> serv_name}}</td>
                                                        <td>{{$doctor_serve -> doctor -> doc_name}}</td>
                                                        <td>{{$doctor_serve -> price}}</td>
                                                        <td> {{$doctor_serve -> getActive()}}</td>
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                 aria-label="Basic example">
                                                                <a href="{{route('admin.doctorserves.edit',$doctor_serve ->id)}}"
                                                                   class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">{{trans('servee_trans.Edite')}}</a>


                                                                <a href="{{route('admin.doctorserves.delete',$doctor_serve ->id)}}"
