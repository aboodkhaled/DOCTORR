  ...
  class DoctorController extends Controller
{
    ...
    public function save(HdoctorRequest $request){
            ...
            if($request->has('photo')){
               ...
               $hdoctors->doc_name = ['en' => $request->doc_name_en, 'ar' => $request->doc_name];
               $hdoctors->doc_degry = ['en' => $request->doc_degry_en, 'ar' => $request->doc_degry];
               $hdoctors->sex = $request->sex;
               $hdoctors->doc_des = ['en' => $request->doc_des_en, 'ar' => $request->doc_des];
               ...
               $hdoctors->address =['en' => $request->address_en, 'ar' => $request->address];
    ...
    public function update($doctor_id, HdoctorRequest $request){
        ...
        $hdoctor -> update([
           $hdoctor->doc_name = ['en' => $request->doc_name_en, 'ar' => $request->doc_name],
               $hdoctor->doc_degry = ['en' => $request->doc_degry_en, 'ar' => $request->doc_degry],
               $hdoctor->sex = $request->sex,
               $hdoctor->doc_des = ['en' => $request->doc_des_en, 'ar' => $request->doc_des],
               ...
               $hdoctor->address =['en' => $request->address_en, 'ar' => $request->address],
