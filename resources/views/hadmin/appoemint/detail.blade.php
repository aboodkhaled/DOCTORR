                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title"> تفاصيل ألدفع: {{$appoemint -> id}} </h4>
							...
							<div class="card-body">
								...
								<div class="text-wrap">
											...
											<div class=" tab-menu-heading">
												<div class="tabs-menu1">
													...
													<ul class="nav panel-tabs main-nav-line">
														<li class="btn-item btn-outline-success"><a href="#tab4" class="nav-link  active" data-toggle="tab"> بيانات ألدفع</a></li>
														<li class="btn-item btn-outline-success"><a href="#tab5" class="nav-link " data-toggle="tab"> بيانات ألحجز</a></li>
                                                        <li class="btn-item btn-outline-success"><a href="#tab7" class="nav-link " data-toggle="tab"> بيانات </a></li>
                                    ...
                                    <div class="card card-statistics">
                                        <div class="card-body">
                                            <form method="post" action="{{ route('admin.appoemints.mate') }}" enctype="multipart/form-data">
                                            @csrf
          ...
          <label for="projectinput2"><h3> ألتاريخ</h3></label>
            <input type="datetime-local" name="start_at" class="form-control">
                                                    ...
                                                    <div class="col-6 col-sm-6 py-2 ">
                                                        ...
                                                        <input type="text" name="doctor_id" value="{{$appoemint ->doctor->id}}">
                                                        <input type="text" name="appoemint_id" value="{{$appoemint ->id}}">
                                                        <input type="text" name="user_id" value="{{$appoemint ->user->id}}">  
                                                <br><br>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach($mates as $mate)
                                                    <tr>
                                                        ...
                                                        <td>{{$mate -> start_at}}</td>
                                                        <td>{{$mate -> duration}}</td>
                                                            <td class="text-danger"><a href="{{$mate->start_url}}" target="_blank">انضم الان</a></td>
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                 aria-label="Basic example">
                                                                <a href="{{route('admin.meeting.edit',$mate ->id)}}"
                                                                   class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">{{trans('servee_trans.Edite')}}</a>


                                                                <a href="{{route('admin.meeting.delete',$mate ->id)}}"
