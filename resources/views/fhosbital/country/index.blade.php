                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('fhosbital.cuontries.store')}}" method="POST"
                                        ...
                                        <table
                                            ...
                                            @isset($hcuontrys)
                                                @foreach($hcuontrys as $hcuontry)
                                                    <tr>
                                                        <td width="5px">{{$hcuontry -> id}}</td>
                                                        <td width="25px">{{$hcuontry -> name}}</td>
                                                        
                                                        <td width="10px">{{$hcuontry -> code}}</td>
                                                        <td width="25px">{{$hcuontry -> key}}</td>
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                 aria-label="Basic example">
                                                                <a href="{{route('fhosbital.cuontries.edit',$hcuontry -> id)}}"
                                                                   class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">{{trans('cuontry_trans.Edite')}}</a>


                                                                <a href="{{route('fhosbital.cuontries.delete',$hcuontry -> id)}}"
