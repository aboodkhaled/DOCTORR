                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> <a href="{{route('fhosbital.cities.index')}}">{{trans('city_trans.Cities')}}</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('fhosbital.cities.store')}}" method="POST"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="fcuontry_id" class="select2 form-control">
                                                                <optgroup label="من فضلك أختر ألدولة ">
                                                                    @if($hcuontrys && $hcuontrys -> count() > 0)
