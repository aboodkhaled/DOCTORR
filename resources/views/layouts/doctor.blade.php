...
<body class="vertical-layout vertical-menu 2-columns  @if(Request::is('doctor/users/tickets/reply*')) chat-application @endif menu-expanded fixed-navbar"
...
<script>
    ...
    var pusher = new Pusher('efe903bb2180a1d6bc90', {
      cluster: 'mt1'
    });

    var channel = pusher.subscribe('new-doctor');
    // Bind a function to a Our Event
    channel.bind('App\\Events\\appoiment', function(data) {
