                ...
                <div class="content-header-left col-md-6 col-12 mb-2">
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('fhosbital.dashboard')}}">{{trans('doctor_trans.Dashbord')}}</a>
                                </li>
                                                ...
                                                @foreach($hdoctors as $hdoctor)
                                                    <tr>
                                                        ...
                                                        <td><img style="width: 150px; height: 100px;"
                                                                 ...
                                                                 <td>{{$hdoctor -> email}}</td>
                                                        <td> {{$hdoctor -> 	fspecialty -> special_name}}</td>
                                                        <td> {{$hdoctor -> 	fdepartment -> dept_name}}</td>
                                                        <td >{{$hdoctor -> fcuontry -> name}}-{{$hdoctor ->fcity -> name}}-{{$hdoctor ->address}}</td>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                <a href="{{route('fhosbital.doctors.edit',$hdoctor ->id)}}"
                                                                   class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">{{trans('doctor_trans.Edite')}}</a>


                                                                <a href="{{route('fhosbital.doctors.delete',$hdoctor ->id)}}"
