                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">تعديل بيانات العميل
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form col-md-12 " action="{{route('admin.hadmins.update' ,$hadmin -> id)}}"
                                              method="POST"
                                            ...
                                            @csrf
                                            <input type="hidden" name="id" value="{{$hadmin -> id}}">
                                            <div class="form-group">
                                                <div class="text-center">
                                                    <img
                                                        src="{{$hadmin -> photo}}"
                                                        class="rounded-circle  height-150" alt="صورة ألعميل  ">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="row col-12 ">
                                                    <div class="col-3 col-sm-3 py-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$hadmin -> name}}" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="name">
                                                            @error("name")
                                                    ...
                                                    <div class="col-3 col-sm-3 py-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" value="{{$hadmin -> mobile}}" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="mobile">
                                                            @error("mobile")
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            onchange="console.log('change is firing')"><label for="projectinput2"> {{trans('doctor_trans.Chose Cuontry')}}</label>
                                                                ...
                                                                @foreach($cuontrys as $cuontry)
                                                                            <option
                                                                                value="{{$cuontry -> id }}"
                                                                                @if($hadmin -> cuontry_id == $cuontry -> id) selected @endif
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="city_id" id="city_id" class="select form-control">
                                                                ...
                                                                @foreach($citys as $city)
                                                                            <option
                                                                                value="{{$city -> id }}"
                                                                                @if($hadmin -> city_id == $city -> id) selected @endif
                                                    ...
                                                    <div class="col-12 col-sm-6 py-2 ">
                                                        <div class="form-group mt-1">
                                                            <input type="checkbox" value="1"
                                                                   ...
                                                                   @if($hadmin -> active  == 1 ) checked @endif
                                                                   />
