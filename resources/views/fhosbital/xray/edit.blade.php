                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('fhosbital.x_rays')}}">{{trans('xray_trans.X-RAYS')}} </a>
                                </li>
                                <li class="breadcrumb-item active">{{trans('xray_trans.Edite X-RAYS')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">{{trans('xray_trans.Edite X-RAYS')}} </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form col-md-12 " action="{{route('fhosbital.x_rays.update' ,$hxray -> id)}}"
                                              method="POST"
                                            ...
                                            <input type="hidden" name="id" value="{{$hxray -> id}}">
                                                ...
                                                <div class="row col-12 ">
                                                    <div class="col-6 col-sm-6 py-2 ">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$hxray -> name}}" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="name">
                                                            @error("name")
                                                    ...
                                                    <div class="col-6 col-sm-6 py-2 ">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" value="{{$hxray -> price}}" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="price">
                                                            @error("price")
                                                    ...
                                                    <div class="col-12 col-sm-6 py-2 ">
                                                        <div class="form-group mt-1">
                                                            <input type="checkbox" value="1"
                                                                   ...
                                                                   @if($hxray -> active  == 1 ) checked @endif
                                                                   />
