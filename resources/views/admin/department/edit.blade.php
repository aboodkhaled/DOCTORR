                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.departments')}}"> {{trans('dept_trans.Show hospitale departments')}} </a>
                                </li>
                                <li class="breadcrumb-item active">{{trans('dept_trans.Edite departments')}} {{$department -> dept_name}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.departments.update', $department -> id)}}" method="POST"
                                                ...
                                                <div class="row">
                                                  ...
                                                  <div class="form-group">
                                                           <label for="dept_des">{{trans('dept_trans.dept_Description_ar')}} </label>
                                                                 ...
                                                                 value="{{ $department->dept_des }}">{{ $department->dept_des }}</textarea>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            <input type="checkbox"  value="1" name="department[0][active]"
                                                                  ...
                                                                  @if($department -> active == 1) checked @endif/>
