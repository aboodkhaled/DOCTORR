...
@section('content')
    ...
    <div class="app-content content">
        <div class="content-wrapper">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form col-md-12 " action="{{route('clinic.serve1s.update' ,$serve1 -> id)}}"
                                              method="POST"
            ...
            <textarea class="form-control" rows="2"  name="think" id="think"  value="{{$serve1 -> think}}"  placeholder="Enter message..">{{$serve1 -> think}}</textarea>
            @error("think")
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
          </div>
                                                ...
                                                <div class="row col-12 ">
                                                      <div class="col-3 col-sm-3 py-6 ">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" value="{{$serve1 -> price}}" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="price">
                                                            @error("price")
                                                    ...
                                                    <div class="col-3 col-sm-3 py-6 ">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" value="{{$serve1 -> thin_price}}" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="thin_price">
                                                            @error("thin_price")
                                                 ...
                                                 <div class="col-3 col-sm-3 py-6 ">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" value="{{$serve1 -> total}}" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="total">
                                                            @error("total")
                                                    ...
                                                    <div class="col-12 col-sm-6 py-2 ">
                                                        <div class="form-group mt-1">
                                                            <input type="checkbox" value="1"
                                                                   ...
                                                                   @if($serve1 -> active  == 1 ) checked @endif
                                                                   />
