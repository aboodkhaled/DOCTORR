...
@section('content')
    ...
    <div class="app-content content">
        <div class="content-wrapper">
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('hosbital.doctors')}}">{{trans('doctor_trans.Doctors')}} </a>
                                </li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form col-md-12 " action="{{route('hosbital.doctors.update' ,$hdoctor -> id)}}"
                                              method="POST"
                                                ...
                                                <div class="row col-12 ">
                                                    <div class="col-3 col-sm-3 py-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$hdoctor -> getTranslation('doc_name','ar')}}" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="doc_name">
                                                            @error("doc_name")
                                                    ...
                                                    <div class="col-3 col-sm-3 py-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$hdoctor -> getTranslation('doc_name','en')}}" id="name_en"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="doc_name_en">
                                                            @error("doc_name_en")
                                                    ...
                                                    <div class="col-6 col-sm-6 py-6 ">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$hdoctor -> getTranslation('doc_degry','ar')}}" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="doc_degry">
                                                            @error("doc_degry")
                                                    ...
                                                    <div class="col-6 col-sm-6 py-6 ">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$hdoctor -> getTranslation('doc_degry','en')}}" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="doc_degry_en">
                                                            @error("doc_degry_en")
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            onchange="console.log('change is firing')"><label for="projectinput2"> {{trans('doctor_trans.Chose Cuontry')}}</label>
                                                                ...
                                                                @foreach($hcuontrys as $hcuontry)
                                                                            <option
                                                                                value="{{$hcuontry -> id }}"
                                                                                @if($hdoctor -> hcuontry_id == $hcuontry -> id) selected @endif
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="hcity_id" id="hcity_id" class="select form-control">
                                                                ...
                                                                @foreach($hcitys as $hcity)
                                                                            <option
                                                                                value="{{$hcity -> id }}"
                                                                                @if($hdoctor -> hcity_id == $hcity -> id) selected @endif
                                                    ...
                                                    <div class="col-6 col-sm-6 py-6 ">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   value="{{$hdoctor -> getTranslation('address','ar')}}"
                                                                   name="address">
                                                            @error("address")
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
                                                    ...
                                                    <div class="col-6 col-sm-6 py-6 ">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   value="{{$hdoctor -> getTranslation('address','en')}}"
                                                                   name="address_en">
                                                            @error("address_en")
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
                                                                ...
                                                                <optgroup label="من فضلك أختر القسم ">
                                                                    ...
                                                                    @foreach($hdepartments as $hdepartment)
                                                                            <option
                                                                                ...
                                                                                @if($hdoctor -> hdepartment_id == $hdepartment -> id) selected @endif
                                                            ...
                                                            <select name="hspecialty_id" class="select2 form-control">
                                                                <optgroup label="من فضلك أختر ألتخصص ">
                                                                    @if($hspecialtys && $hspecialtys -> count() > 0)
                                                                        ...
                                                                        <option
                                                                                value="{{$hspecialty -> id }}"
                                                                                @if($hdoctor -> hspecialty_id == $hspecialty -> id) selected @endif
            ...
            <textarea class="form-control" rows="2"  name="doc_des" id="doc_des"   value="{{$hdoctor -> getTranslation('doc_des','ar')}}"  placeholder="Enter message.."></textarea>
            @error("doc_des")
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
          </div>
            ...
            <textarea class="form-control" rows="2"  name="doc_des_en" id="doc_des_en"   value="{{$hdoctor -> getTranslation('doc_des','en')}}"  placeholder="Enter message.."></textarea>
            @error("doc_des_en")
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
          </div>
    ...
    <script>
        $(function(){
            ...
            function  populateHcities(){
                ...
                var cuontryId = $('#hcuontry_id').val() != null ? $('#hcuontry_id').val() : '{{old('hcuontry_id')}}';
                $.get("{{Route('hosbital.doctors.getcity')}}",{hcuontry_id: cuontryId }, function(data){
