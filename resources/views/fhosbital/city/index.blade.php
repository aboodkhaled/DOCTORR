                        ...
                        <div class="col-12">
                            ...
                            <div class="card-header">
                                ...
                                <div class="btn-group" role="group"
                                                                ...
                                                                <a href="{{route('fhosbital.cities.create')}}"
                                            ...
                                            @isset($hcitys)
                                                @foreach($hcitys as $hcity)
                                                    <tr>
                                                        ...
                                                        <td width="25px">  {{$hcity -> 	fcuontry -> name}}</td>
                                                        
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                 aria-label="Basic example">
                                                                <a href="{{route('fhosbital.cities.edit',$hcity -> id)}}"
                                                                   class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">{{trans('city_trans.Edite')}}</a>


                                                                <a href="{{route('fhosbital.cities.delete',$hcity -> id)}}"
