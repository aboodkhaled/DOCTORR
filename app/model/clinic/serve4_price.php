...
class serve4_price extends Model
{
   
   
    
    protected $table ="serve4_prices";
    protected $fillable = [
      'serve4_id', 'price', 'clinic_id', 'created_at', 'updated_at',
    ];
    protected $hidden = [
    ...
    public function clinic(){
      ...
      public function appoemint4(){
        return $this -> hasMany(appoemint4::class, 'serve4_price_id', 'id' );
    }
}
