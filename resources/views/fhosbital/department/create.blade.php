                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('fhosbital.departments')}}">{{trans('dept_trans.hospitale departments')}} </a>
                                </li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('fhosbital.departments.save')}}" method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label    for="dept_name_en">  {{trans('dept_trans.dept_Neme_en')}}   </label>
                                                            <input type="text" value="" id="dept_name_en"
                                                                   class="form-control"
                                                                   placeholder="ادخل اسم ألقسم  "
                                                                   name="dept_name_en">
                                                            @error('dept_name_en')
                                                ...
                                                <div class="col-md-12">
                                                  <div class="form-group">
                                                           <label for="dept_des_en"> {{trans('dept_trans.dept_Description_en')}} </label>
                                                                 <textarea class="form-control" id="dept_des_en" rows="3" placeholder="ادخل  ألوصف" name="dept_des_en"></textarea>
