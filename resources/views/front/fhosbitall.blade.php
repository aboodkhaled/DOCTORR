...
<body>
 ...
 @include('front.includes.hheader')      
  ...
  <div class="page-hero bg-image overlay-dark" style="background-image: url({{$fhosbital -> 	photo}});">
  <div class="hero-section">
      <div class="container text-center wow zoomIn">
      <span class=" subhead  display-4">مرحبا بكم في مستشفئ / {{$fhosbital -> 	name}} ألصحية </span> <br><br>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 py-3 wow fadeInUp">
            ...
            <h2 class="text-grey mb-4">{{$fhosbital -> des}}</h2>
 ...
 @include('front.includes.fdoctor')
 
 @include('front.includes.flatest')
