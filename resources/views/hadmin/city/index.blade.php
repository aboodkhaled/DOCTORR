                        ...
                        <div class="col-12">
                            ...
                            <div class="card-header">
                                ...
                                <div class="btn-group" role="group"
                                                                ...
                                                                <a href="{{route('hadmin.cities.create')}}"
                                        ...
                                        <table
                                            ...
                                            @isset($citys)
                                                @foreach($citys as $city)
                                                    <tr>
                                                        <td width="5px">{{$city -> id}}</td>
                                                        <td width="25px">{{$city -> name}}</td>
                                                        
                                                        <td width="25px">  {{$city -> 	cuontry -> name}}</td>
                                                        
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                 aria-label="Basic example">
                                                                <a href="{{route('hadmin.cities.edit',$city -> id)}}"
                                                                   class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">{{trans('city_trans.Edite')}}</a>


                                                                <a href="{{route('hadmin.cities.delete',$city -> id)}}"
