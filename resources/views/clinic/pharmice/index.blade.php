...
@section('content')
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('clinic.serve1s')}}"> خدمات  ألأاسعافات ألاولية </a>
                                </li>
                                <li class="breadcrumb-item active">أظافة خدمة ألأاسعافات ألاولية
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> أظافة خدمة ألأاسعافات ألاولية </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form col-md-12 " action="{{route('clinic.serve1s.save')}}"
                                              method="POST"
                                            ...
                                            @csrf
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i> بيانات خدمة ألأاسعافات ألأولية</h4>
    ...
    <div class="app-content content">
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">  خدمات ألأاسعافات ألاولية   </h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('clinic.dashboard')}}">ألصفحة ألرئيسية</a>
                                </li>
                                <li class="breadcrumb-item active"> خدمات ألأاسعافات ألاولية
                                </li>
                            </ol>
                        </div>
                    </div>
                ...
                <section id="dom">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">جميع خدمات ألأاسعافات ألاولية</h4>
                                    <a class="heading-elements-toggle"><i
                                            class="la la-ellipsis-v font-medium-3"></i></a>
                                    <div class="heading-elements">
                                        <ul class="list-inline mb-0">
                                            ...
                                            @isset($serve1s)
                                                @foreach($serve1s as $serve1)
                                                    <tr>
                                                        ...
                                                        <td> {{$serve1 -> think}}</td>
                                                        <td> {{$serve1 ->price}}</td>
                                                        <td>{{$serve1 -> thin_price}}</td>
                                                        <td>{{$serve1 -> total}}</td>
                                                        <td> {{$serve1 -> getActive()}}</td>
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                 aria-label="Basic example">
                                                                <a href="{{route('clinic.serve1s.edit',$serve1 ->id)}}"
                                                                   class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">{{trans('pharmice_trans.Edite')}}</a>


                                                                <a href="{{route('clinic.serve1s.delete',$serve1 ->id)}}"
