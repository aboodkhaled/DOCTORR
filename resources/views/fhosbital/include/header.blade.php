        ...
        <div class="navbar-container content">
         ...
         <h1>لغة ألموقع</h1>
                ...
                <span class="mr-1">{{trans('main_trans.Hello')}}
                  ...
                  <span
                      class="user-name text-bold-600">  {{auth('fhosbitall') -> user() -> name}}   </span><span class="avatar avatar-sm avatar-busy rounded-circle"><img class="brand-logo" 
                             src="{{auth('fhosbitall') -> user() -> photo}}"> </span>
                            <br> {{auth('fhosbitall') -> user() -> email}}                            
                </span>
                
                         </a>
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="{{route('fhosbital.edit.profile')}}"><i
                                    class="ft-user"></i> تعديل الملف الشحصي </a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{route('fhosbital.logout')}}"><i class="ft-power"></i> تسجيل
                                الخروج </a>
                        </div>
                    </li>
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        <a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon ft-bell"></i>
                            ...
                            data-count="" ><h6 id="notifications_coun">{{auth('fhosbitall')->user()->unreadNotifications->count() }}</h6></span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            ...
                            <li class="dropdown-menu-header">
                                ...
                                <span
                                    class="notification-tag badge badge-default badge-danger float-right m-0"><h6 id="notifications_cou">{{auth('fhosbitall')->user()->unreadNotifications->count() }}</h6></span>
                            </li>
                            
                            <li class="scrollable-container media-list w-100">
                            <div id="unreadNotificats">
                            @foreach(auth('fhosbitall')->user()->unreadNotifications as $notification)
                                <a href="{{route('fhosbital.appoemints.show',$notification->data['id'])}}">
                                    <div class="media">
                           ...
                           <div>
                            <li class="dropdown-menu-footer"><a class="dropdown-item text-muted text-center"
                                                                href="{{route('fhosbital.appoemints.MarkAsRead')}}"> {{trans('lab_trans.Read all notifications')}}</a>
                            </li>
                            </div>
