      ...
      <a class="navbar-brand" href="#"><span class="text-primary">Bisat</span>-areeh</a>
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span
                    class="user-name text-bold-600">  {{auth('venlabe') -> user() -> name}}   </span><span class="avatar avatar-sm avatar-busy rounded-circle"><img class="brand-logo" alt="modern admin logo"
                           src="{{auth('venlabe') -> user() -> photo}}"> </span>
                          <br> {{auth('venlabe') -> user() -> email}}                            
              </span>
