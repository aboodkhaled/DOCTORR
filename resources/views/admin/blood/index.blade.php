                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.bloods')}}">{{trans('blood_trans.Blood Types')}} </a>
                                </li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form col-md-12 " action="{{route('admin.bloods.save')}}"
                                              method="POST"
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{trans('blood_trans.Dashbord')}}</a>
                                </li>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <td>{{ $i }}</td>
                                                        ...
                                                        <td> {{$blood -> blood_typ}}</td>
                                                       
                                                       
                                            
                                                        <td> {{$blood -> getActive()}}</td>
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                 aria-label="Basic example">
                                                                <a href="{{route('admin.bloods.edit',$blood ->id)}}"
                                                                   class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">{{trans('blood_trans.Edite')}}</a>


                                                                <a href="{{route('admin.bloods.delete',$blood ->id)}}"
