...
class serve3_tprice extends Model
{
    
   
    
    protected $table ="serve3_tprices";
    protected $fillable = [
      'serve3_id', 'thin_price', 'clinic_id', 'created_at', 'updated_at',
    ];
    protected $hidden = [
    ...
    public function clinic(){
      ...
      public function appoemint3(){
        return $this -> hasMany(appoemint3::class, 'serve3_tprice_id', 'id' );
    }
}
