...
class serve2_total extends Model
{
   
   
    
    protected $table ="serve2_totals";
    protected $fillable = [
      'serve2_id', 'total', 'clinic_id', 'created_at', 'updated_at',
    ];
    protected $hidden = [
    ...
    public function clinic(){
      ...
      public function appoemint2(){
        return $this -> hasMany(appoemint2::class, 'serve2_total_id', 'id' );
    }
}
