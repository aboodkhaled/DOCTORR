                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form col-md-12 " action="{{route('fhosbital.labes.save')}}"
                                              method="POST"
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('fhosbital.dashboard')}}">{{trans('test_trans.Dashbord')}}</a>
                                </li>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <table
                                            ...
                                            <?php $i = 0; ?>
                                            @isset($hlabes)
                                                @foreach($hlabes as $hlabe)
                                                    <tr>
                                                    <?php $i++; ?>
                                <td>{{ $i }}</td>
                                                        <td>{{$hlabe -> lab_name}}</td>
                                                       
                                                        <td> {{$hlabe -> axam_name}}</td>
                                                        <td> {{$hlabe ->price}}</td>
                                                       
                                            
                                                        <td> {{$hlabe -> getActive()}}</td>
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                 aria-label="Basic example">
                                                                <a href="{{route('fhosbital.labes.edit',$hlabe ->id)}}"
                                                                   class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">{{trans('test_trans.Edite')}}</a>


                                                                <a href="{{route('fhosbital.labes.delete',$hlabe ->id)}}"
