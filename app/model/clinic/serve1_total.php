...
class serve1_total extends Model
{
   
    protected $table ="serve1_totals";
    protected $fillable = [
      'serve1_id', 'total', 'clinic_id', 'created_at', 'updated_at',
    ];
    protected $hidden = [
    ...
    public function clinic(){
      ...
      public function appoemint1(){
        return $this -> hasMany(appoemint1::class, 'serve1_total_id', 'id' );
    }
}
