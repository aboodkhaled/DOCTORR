<div class="page-section bg-light">
    ...
    <div class="container">
      <h1 class="text-center wow fadeInUp">أقسام مستشفى/{{$hosbital -> name}}</h1>
      ...
      @foreach($hdepartment  as $_department)
        <div class="col-lg-4 py-1 wow-zoomIn">
          ...
          <div class="card-blog">
            ...
            <div class="header">
              ...
              <a href="{{route('hdepartment',$_department -> id)}}" class="post-thumb">
        ...
        <div class="col-12 text-center mt-4 wow zoomIn">
          <a href="{{route('hdepartment',$_department -> id)}}" class="btn btn-primary">Read More</a>
        </div>
