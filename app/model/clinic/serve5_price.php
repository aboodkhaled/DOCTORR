...
class serve5_price extends Model
{
   
   
    
    protected $table ="serve5_prices";
    protected $fillable = [
      'serve5_id', 'price', 'clinic_id', 'created_at', 'updated_at',
    ];
    protected $hidden = [
    ...
    public function clinic(){
      ...
      public function appoemint5(){
        return $this -> hasMany(appoemint5::class, 'serve5_price_id', 'id' );
    }
}
