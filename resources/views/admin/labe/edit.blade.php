                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form col-md-12 " action="{{route('admin.labes.update' ,$labe -> id)}}"
                                              method="POST"
                                            ...
                                            <input type="hidden" name="id" value="{{$labe -> id}}">
                                                ...
                                                <div class="row col-12 ">
                                                    <div class="col-6 col-sm-6 py-2 ">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$labe -> lab_name}}" id="lab_name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="lab_name">
                                                            @error("lab_name_en")
                                                    ...
                                                    <div class="col-6 col-sm-6 py-2 ">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$labe -> axam_name}}" id="axam_name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="axam_name">
                                                            @error("axam_name")
                                                    ...
                                                    <div class="col-6 col-sm-6 py-2 ">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" value="{{$labe -> price}}" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="price">
                                                            @error("price")
                                                    ...
                                                    <div class="col-12 col-sm-6 py-2 ">
                                                        <div class="form-group mt-1">
                                                            <input type="checkbox" value="1"
                                                                   ...
                                                                   @if($labe -> active  == 1 ) checked @endif
                                                                   />
