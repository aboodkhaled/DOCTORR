                ...
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('fhosbital.dashboard')}}">{{trans('cuontry_trans.Dashbord')}} </a>
                                </li>
                                <li class="breadcrumb-item"><a href="{{route('fhosbital.cuontries.index')}}"> {{trans('cuontry_trans.Cuontries')}} </a>
                                </li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('fhosbital.cuontries.update', $hcuontry -> id)}}" method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$hcuontry -> name}}" id="name"
                                                                   class="form-control"
