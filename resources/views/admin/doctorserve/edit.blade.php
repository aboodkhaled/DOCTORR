                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.doctorserves')}}">{{trans('servee_trans.Serves Doctors')}} </a>
                                </li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form col-md-12 " action="{{route('admin.doctorserves.update' ,$doctor_serve -> id)}}"
                                              method="POST"
                                                ...
                                                <div class="row col-12 ">
                                                                ...
                                                                <optgroup label="من فضلك أختر ألخدمة ">
                                                                    @if($serves && $serves -> count() > 0)
                                                                        @foreach($serves as $serve)
                                                                            <option
                                                                                value="{{$serve -> id }}"
                                                                                @if($doctor_serve -> serve_id == $serve -> id) selected @endif>{{$serve -> serv_name}}</option>
                                                                        @endforeach
                                                                    @endif
                                                                </optgroup>
                                                            </select>
                                                                ...
                                                                <optgroup label="من فضلك أختر ألطبيب ">
                                                                    @if($doctors && $doctors -> count() > 0)
                                                                        @foreach($doctors as $doctor)
                                                                            <option
                                                                            value="{{$doctor -> id }}"
                                                                                @if($doctor_serve -> doctor_id == $doctor -> id) selected @endif
                                                    ...
                                                    <div class="col-6 col-sm-6 py-2 ">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" value="{{$doctor_serve -> price}}" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="price">
                                                            @error("price")
                                                    ...
                                                    <div class="col-12 col-sm-6 py-2 ">
                                                        <div class="form-group mt-1">
                                                            <input type="checkbox" value="1"
                                                                   ...
                                                                   @if($doctor_serve -> active  == 1 ) checked @endif
                                                                   />
