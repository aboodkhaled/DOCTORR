                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form col-md-12 " action="{{route('hosbital.x_rays.update' ,$hxray -> id)}}"
                                              method="POST"
                                                ...
                                                <div class="row col-12 ">
                                                    <div class="col-6 col-sm-6 py-2 ">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$hxray -> getTranslation('name','ar')}}" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="name">
                                                            @error("name")
                                                    ...
                                                    <div class="col-6 col-sm-6 py-2 ">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$hxray -> getTranslation('name','en')}}" id="name_en"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="name_en">
                                                            @error("name_en")
