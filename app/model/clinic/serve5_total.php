...
class serve5_total extends Model
{
   
   
    
    protected $table ="serve5_totals";
    protected $fillable = [
      'serve5_id', 'total', 'clinic_id', 'created_at', 'updated_at',
    ];
    protected $hidden = [
    ...
    public function clinic(){
      ...
      public function appoemint5(){
        return $this -> hasMany(appoemint5::class, 'serve5_total_id', 'id' );
    }
}
