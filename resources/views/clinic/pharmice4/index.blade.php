                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('clinic.serve4s')}}">خدمات  ألمعالجة ألطبيعية والتنفسية </a>
                                </li>
                                <li class="breadcrumb-item active">أظافة خدمات  ألمعالجة ألطبيعية والتنفسية   
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> أظافة خدمات  ألمعالجة ألطبيعية والتنفسية </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form col-md-12 " action="{{route('clinic.serve4s.save')}}"
                                              method="POST"
                                            ...
                                            @csrf
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i>بيانات  خدمات  ألمعالجة ألطبيعية والتنفسية</h4>
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> خدمات  ألمعالجة ألطبيعية والتنفسية
                                </li>
                            </ol>
                        </div>
                    </div>
                ...
                <section id="dom">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">جميع خدمات  ألمعالجة ألطبيعية والتنفسية</h4>
                                    <a class="heading-elements-toggle"><i
                                            class="la la-ellipsis-v font-medium-3"></i></a>
                                    <div class="heading-elements">
                                        <ul class="list-inline mb-0">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <table
                                            ...
                                            @isset($serve4s)
                                                @foreach($serve4s as $serve4)
                                                    <tr>
                                                        <td>{{$serve4 -> name}}</td>
                                                       
                                                        <td> {{$serve4 -> think}}</td>
                                                        <td> {{$serve4 ->price}}</td>
                                                        <td>{{$serve4 -> thin_price}}</td>
                                                        <td>{{$serve4 -> total}}</td>
                                                        <td> {{$serve4 -> getActive()}}</td>
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                 aria-label="Basic example">
                                                                <a href="{{route('clinic.serve4s.edit',$serve4 ->id)}}"
                                                                   class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">{{trans('pharmice_trans.Edite')}}</a>


                                                                <a href="{{route('clinic.serve4s.delete',$serve4 ->id)}}"
