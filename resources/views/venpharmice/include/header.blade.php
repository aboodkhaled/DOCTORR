      ...
      <a class="navbar-brand" href="#"><span class="text-primary">Bisat</span>-areeh</a>
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span
                    class="user-name text-bold-600">  {{auth('venpharmice') -> user() -> name}}   </span><span class="avatar avatar-sm avatar-busy rounded-circle"><img class="brand-logo" alt="modern admin logo"
                           src="{{auth('venpharmice') -> user() -> photo}}"> </span>
                          <br> {{auth('venpharmice') -> user() -> email}}                            
              </span>
                        ...
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="{{route('edit.profile')}}"><i
                            ...
                            <a class="dropdown-item" href="{{route('venpharmice.logout')}}"><i class="ft-power"></i> تسجيل
                                الخروج </a>
                        </div>
                    </li>

                    <li class="dropdown dropdown-user nav-item">
                        <a class="dr    opdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                <span class="mr-1">
                  <span
