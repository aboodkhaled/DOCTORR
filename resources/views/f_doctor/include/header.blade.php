        ...
        <div class="navbar-container content">
         ...
         <h1>لغة ألموقع</h1>
                ...
                <span class="mr-1">{{trans('main_trans.Hello')}}
                  ...
                  <span
                      class="user-name text-bold-600">  {{auth('f_doctor') -> user() -> doc_name}}   </span><span class="avatar avatar-sm avatar-busy rounded-circle"><img class="brand-logo" 
                             src="{{auth('f_doctor') -> user() -> photo}}"> </span>
                            <br> {{auth('f_doctor') -> user() -> email}}                            
                </span>
                
                         </a>
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="{{route('f_doctor.edit.profile')}}"><i
                                    class="ft-user"></i> تعديل الملف الشحصي </a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{route('f_doctor.logout')}}"><i class="ft-power"></i> تسجيل
                                الخروج </a>
                        </div>
                    </li>
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        <a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon ft-bell"></i>
                            ...
                            data-count="" ><h6 id="notifications_coun">{{auth('f_doctor')->user()->unreadNotifications->count() }}</h6></span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            ...
                            @foreach(auth('f_doctor')->user()->unreadNotifications as $notification)
                                <a href="{{route('f_doctor.sikss.show',$notification->data['id'])}}">
                                    <div class="media">
                           ...
                           <div>
                            <li class="dropdown-menu-footer"><a class="dropdown-item text-muted text-center"
                                                                href="{{route('f_doctor.sikss.MarkAsRead')}}"> {{trans('lab_trans.Read all notifications')}}</a>
                            </li>
                            </div>
