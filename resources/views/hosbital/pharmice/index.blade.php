                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('hosbital.pharmices')}}"> {{trans('pharmice_trans.Medicines')}}  </a>
                                </li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form col-md-12 " action="{{route('hosbital.pharmices.save')}}"
                                              method="POST"
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('hosbital.dashboard')}}">{{trans('pharmice_trans.Dashbord')}}</a>
                                </li>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <table
                                            ...
                                            @isset($hpharmices)
                                                @foreach($hpharmices as $hpharmice)
                                                    <tr>
                                                        <td>{{$hpharmice -> name}}</td>
                                                       
                                                        <td> {{$hpharmice -> exp_date}}</td>
                                                        <td> {{$hpharmice ->price}}</td>
                                                        <td>{{$hpharmice -> qun}}</td>
                                            
                                                        <td> {{$hpharmice -> getActive()}}</td>
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                 aria-label="Basic example">
                                                                <a href="{{route('hosbital.pharmices.edit',$hpharmice ->id)}}"
                                                                   class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">{{trans('pharmice_trans.Edite')}}</a>


                                                                <a href="{{route('hosbital.pharmices.delete',$hpharmice ->id)}}"
