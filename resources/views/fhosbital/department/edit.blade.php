                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('fhosbital.departments')}}"> {{trans('dept_trans.Show hospitale departments')}} </a>
                                </li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('fhosbital.departments.update', $hdepartment -> id)}}" method="POST"
                                                ...
                                                <div class="row">
                                                  ...
                                                  <div class="form-group">
                                                           <label for="dept_des">{{trans('dept_trans.dept_Description_ar')}} </label>
                                                                 ...
                                                                 value="{{ $hdepartment->dept_des }}">{{ $hdepartment->dept_des }}</textarea>
