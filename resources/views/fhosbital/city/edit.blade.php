                ...
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('fhosbital.dashboard')}}">{{trans('city_trans.Dashbord')}} </a>
                                </li>
                                <li class="breadcrumb-item"><a href="{{route('fhosbital.cities.index')}}"> {{trans('city_trans.Cities')}}</a>
                                </li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('fhosbital.cities.update', $hcity -> id)}}" method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="fcuontry_id" class="select2 form-control">
                                                                <optgroup label="من فضلك أختر ألدولة ">
                                                                    @if($hcuontry && $hcuontry -> count() > 0)
                                                                        @foreach($hcuontry as $_cuontry)
                                                                            <option
                                                                            value="{{$_cuontry -> id }}"
                                                                                @if($hcity -> fcuontry_id == $_cuontry -> id) selected @endif
