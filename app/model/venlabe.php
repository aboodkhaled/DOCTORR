...
use App\model\city;
class venlabe extends Authenticatable
{
    use Notifiable;
   
    
    protected $table ="venlabes";


    protected $fillable = [
        'name',  'email', 'photo', 'password', 'mobile', 'active', 'sup_date', 'sup_price', 'suppay_price', 'pay_time', 'pay_date', 'status', 'cuontry_id','city_id', 'address', 'created_at', 'updated_at',
    ];
